<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                   <a class="text-2xl hover:text-4xl transition-all hover:text-orange-600 font-bold" href="/">Ferre</a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    
                    <x-jet-nav-link href="{{route('admin.welcome')}}" :active="request()->routeIs('admin.welcome')">
                        Inicio
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{route('admin.subcategories.index')}}" :active="request()->routeIs('admin.subcategories.index')">
                        Subcategorias
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{route('admin.welcome')}}" :active="request()->routeIs('admin.welcome')">
                Inicio
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{route('admin.index')}}" :active="request()->routeIs('admin.index')">
                Productos
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{route('admin.orders.index')}}" :active="request()->routeIs('admin.index')">
                Ordenes
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{route('admin.subcategories.index')}}" :active="request()->routeIs('admin.subcategories.index')">
                Subcategorias
            </x-jet-responsive-nav-link>
